...
const Profile = () => {
    ...
    <nav className="nav bd_grid">
      ...
      <div className="nav_menu" id="nav_menu">
        <ul className="nav_list">
          ...
          <li className="nav_items">
            <a href="#work" className="nav_link active">Work</a>
          </li>
          <li className="nav_items">
            <a href="#contact" className="nav_link active">Contact</a>
          </li>
        </ul>
      </div>
      ...
      <div className="nav_toggle" id="nav_toggle">
        ...
        <img
          src="/ProtFolio_Project/img/navicon.png"
          alt=""
          className="navicon"
        />
      </div>
  ...
  <main className="main">
    ...
    <section className="home bd_grid" id="home">
      <div className="home_data" data-aos="fade-down" data-aos-delay="250">
      ...
      <div className="home_social" data-aos="fade-down">
        ...
        ></a>
         <a href={"https://github.com/yagesh-ohh?tab=repositories"} target="_blank"rel="noreferrer" className="footer_icon" >
      ...
      <div className="home_img" data-aos="fade-right" data-aos-delay="250">
        <svg
    ...
    <section className="about section" id="about">
      ...
      <div
        className="about_container bd_grid"
        data-aos="fade-right"
        data-aos-delay="250"
      >
        ...
        <div data-aos="fade-left" data-aos-delay="250">
          <h2 className="about_subtitle">I'm Yagesh Raju</h2>
          <p className="about_text">
            I completed my B.a English in correspondence in 2023 and know about Frontend  developing technologies like HTML, CSS, Javascript and React.js
            and I have a little bit of knowledge of the Backend side like express.js and mongoDB
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="skills_container bd_grid">
        <div>
          ...
          <p className="skills_text">
            Without sharpen your weapon; tanding on the battlefield would not
            increase your chance of winning
          </p>
          {/* <!--  Skills Progressbar HTML5 --> */}

          <div className="skills_data" data-aos="flip-left" data-aos-delay="250">
            <div className="skills_name">
              <i className="bx bxl-html5 skills_icon"></i>
              <span className="skills_name">HTML 5</span>
            </div>
            <div><span className="skills_percentage">95%</span></div>
            <div className="skill_bar skill_html"></div>
          </div>

          {/* <!--  Skills Progressbar CSS --> */}

          <div className="skills_data" data-aos="flip-left" data-aos-delay="350">
            <div className="skills_name">
              <i className="bx bxl-css3 skills_icon"></i>
              <span className="skills_name">CSS 3</span>
            </div>
            <div><span className="skills_percentage">85%</span></div>
            <div className="skill_bar skill_css"></div>
          </div>
          {/* <!--  Skills Progressbar JAVASCRIPT --> */}

          <div className="skills_data" data-aos="flip-left" data-aos-delay="450">
            <div className="skills_name">
              <i className="bx bxl-javascript skills_icon"></i>
              <span className="skills_name">JAVASCRIPT</span>
            </div>
            <div><span className="skills_percentage">80%</span></div>
            <div className="skill_bar skill_javascript"></div>
          </div>
          {/* <!--  --> */}

          {/* <!--  Empt Progressbar JAVASCRIPT --> */}

          <div className="skills_data" data-aos="flip-left" data-aos-delay="550">
            <div className="skills_name">
              <i className="bx bxl-angular skills_icon"></i>
              <span className="skills_name">React.js</span>
            </div>
            <div><span className="skills_percentage">60%</span></div>
            <div className="skill_bar skill_angular"></div>
          </div>
        ...
        {/* <!-- --------------------  SVG IMG START      -------------> */}
        <div className="skill_img" data-aos="zoom-in" data-aos-delay="550">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            data-name="Layer 1"
    ...
    {/* <section className="contact section">
      ...
      <div className="contact_container bd_grid">
        <form action="" className="contact_form">
          ...
          <input type="button" value="Send" className="control_button button" />
        </form>
      </div>
    </section> */}
